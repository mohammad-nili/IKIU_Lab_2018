...
@section('star_points')
    حداقل مقدار نمونه ۲۰ میلی گرم باشد.محدوده ی دما ۲۵−۱۰۰۰ است . قابل اشتعال و انفجار نباشد. افزایش شدید حجم نداشته باشد و به صورت پودری باشد.
@endsection
        ...
        <td  style="margin: 0;padding: 0">
            <table style="margin: 0;padding: 0">
                <tr>
                    ...
                    <td><input type="hidden" name="{{'sample_name2'}}" value="محدوده تغییر دما">محدوده تغییر دما</td>
                    <td><input type="hidden" name="{{'sample_name3'}}" value="محیط آنالیز">محیط آنالیز (نیتروژن یا اتمسفر)</td>
                    <td><input type="hidden" name="{{'sample_name4'}}" value="توضیحات">توضیحات</td>
                    <td><input type="hidden" name="{{'sample_name5'}}" value="نرخ تغییرات">نرخ تغییرات(دقیقه/درجه)</td>
                    <td><input type="hidden" name="{{'sample_name6'}}" value="درصد کربن">درصد کربن</td>
                </tr>
                @for($r=0;$r<=2;$r++)
                    <tr>
                        @for($c=0;$c<=6;$c++)
