        ...
        <td  style="margin: 0;padding: 0">
            <table style="margin: 0;padding: 0">
                <tr>
                    ...
                    <td rowspan="2"><input type="hidden" name="{{'sample_name5'}}" value="DRS Diffuse Reflectance Spectroscopy">DRS Diffuse Reflectance Spectroscopy</td>
                    <td colspan="2">محدوده موج مورد نظر</td>
                </tr>
                <tr>
                    <td><input type="hidden" name="{{'sample_name6'}}" value="UV_Vis">UV_Vis</td>
                    <td><input type="hidden" name="{{'sample_name7'}}" value="NIR">NIR</td>
                </tr>
                @for($r=0;$r<=3;$r++)
                    <tr>
                        @for($c=0;$c<=7;$c++)
            ...
            <td style="margin: 0;padding: 0">
                <table style="margin: 0;padding: 0">
                    <tr>
                        ...
                        <td rowspan="2">DRS Diffuse Reflectance Spectroscopy</td>
                        <td colspan="2">محدوده موج مورد نظر</td>
                    </tr>
                    <tr>
                        <td>UV_Vis</td>
