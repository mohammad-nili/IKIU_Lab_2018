    ...
    <table class="table-4">
        <tr>
            ...
            <td>
                ...
                <span style="margin: 0 15px">cDNA<input type="radio" name="sample_type" value="cDNA"></span>
            </td>
        </tr>
        <tr>
            <td  style="margin: 0;padding: 0">
                <table style="margin: 0;padding: 0">
                    <tr>
                        ...
                        <td><input type="hidden" name="{{'sample_name3'}}" value="دمای اتصال">دمای اتصال</td>
                        <td><input type="hidden" name="{{'sample_name4'}}" value="اندازه محصول">اندازه محصول</td>
                        <td><input type="hidden" name="{{'sample_name5'}}" value="تعداد سیکل">تعداد سیکل</td>
    ...
    <table class="table-4">
        <tr>
            ...
            <td>
                ...
                <span style="margin: 0 15px">cDNA<input disabled type="radio" @if($request->sample->first()->type=='cDNA') checked @endif  name="sample_type" value="cDNA"></span>
            </td>
        </tr>
        <tr>
