    ...
    <table class="table-4">
        <tr>
            ...
            <td>
                ...
                <span style="margin: 0 15px">لوازم آزمایشگاهی<input type="radio" name="sample_type" value="لوازم آزمایشگاهی"></span>
            </td>
        </tr>
        <tr>
    ...
    <table class="table-4">
        <tr>
            ...
            <td>
                ...
                <span style="margin: 0 15px">لوازم آزمایشگاهی<input disabled type="radio" @if($request->sample->first()->type=='لوازم آزمایشگاهی') checked @endif  name="sample_type" value="لوازم آزمایشگاهی"></span>
            </td>
        </tr>
        <tr>
