...
@section('star_points')
    ۱− مقدار نمونه ها ،بسته به سایز نمونه ها متفاوت بوده و حداقل مقدار نمونه دانه ریز باید یک کیلوگرم باشد. ۲− برچسب روی هر نمونه باید شامل نام متقاضی ، نام نمونه باشد. ۳− محیط برداشت نمونه مشخص باشد. ۴− عمق برداشت نمونه مشخص باشد. ۵− نمونه ها به صورت کاملاً سیستماتیک برداشت شده باشد. ۶− نمونه ها در دستگاه شیکر به مدت ۱۵ دقیقه ، الک میشوند و پس از وزن کشی و انجام محاسبات ، فراوانی دانه ها و نوع رسوب تعیین می گردد.
@endsection
