...
@section('star_points')
    در انجام پرس در صورت نیاز به قالب خاص ، تامین قالب با مشتری میباشد.
@endsection
        ...
        <td  style="margin: 0;padding: 0">
            <table style="margin: 0;padding: 0">
                <tr>
                    ...
                    <td><input type="hidden" name="{{'sample_name2'}}" value="نوع پرس سرد/گرم">نوع پرس سرد/گرم</td>
                    <td><input type="hidden" name="{{'sample_name3'}}" value="دمای تست">دمای تست</td>
                    <td><input type="hidden" name="{{'sample_name4'}}" value="نیاز به قالب دارد/ندارد">نیاز به قالب دارد/ندارد</td>
                    <td><input type="hidden" name="{{'sample_name5'}}" value="سایر مشخصات ضروری">سایر مشخصات ضروری</td>
                </tr>
                @for($r=0;$r<=3;$r++)
                    <tr>
                        @for($c=0;$c<=5;$c++)
