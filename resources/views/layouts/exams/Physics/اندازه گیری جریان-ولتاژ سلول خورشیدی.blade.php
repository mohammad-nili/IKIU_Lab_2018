...
@section('star_points')
    ابعاد زیر لایه نباید کمتر از ۱ سانتیمتر مربع باشد.
@endsection
            ...
            <td  style="margin: 0;padding: 0">
                <table style="margin: 0;padding: 0">
                    <tr>
                        ...
                        <td><input type="hidden" name="{{'sample_name3'}}" value="دقت مورد نیاز برای داده های I-V">دقت مورد نیاز برای داده های I-V</td>
                        <td><input type="hidden" name="{{'sample_name4'}}" value="دامنه اندازی گیری مورد نیاز برای داده های I-V">دامنه اندازی گیری مورد نیاز برای داده های I-V</td>
