            ...
            <td  style="margin: 0;padding: 0">
                <table style="margin: 0;padding: 0">
                    <tr>
                        ...
                        <td><input type="hidden" name="{{'sample_name3'}}" value="دمای آزمایش">دمای آزمایش</td>
                        <td><input type="hidden" name="{{'sample_name4'}}" value="زمان">زمان</td>
                        <td><input type="hidden" name="{{'sample_name5'}}" value="سرعت آزمایش">سرعت آزمایش</td>
                    </tr>
                    @for($r=0;$r<=3;$r++)
                        <tr>
                            @for($c=0;$c<=5;$c++)
